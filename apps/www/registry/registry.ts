...
const example: Registry = [
  ...
  },
  {
    ...
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-02-input.tsx"],
  },
  {
    name: "test-03-form",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-03-form.tsx"],
  },
  {
    name: "test-04-error",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-04-error.jsx"],
  },
  {
    name: "test-05-message",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-05-message.jsx"],
  },
  {
    name: "test-06-fetch",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-06-fetch.jsx"],
  },
  {
    name: "test-07-fetch-msw",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-07-fetch-msw.jsx"],
  },
  {
    name: "test-08-editor",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-08-editor.jsx"],
  },
  {
    name: "test-another-demo",
    type: "components:example",
    registryDependencies: ["alert-dialog", "button"],
    files: ["example/test-another-demo.tsx"],
  },
  {
